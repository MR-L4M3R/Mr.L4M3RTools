...
echo $w"==============================================="
sleep 1
echo $cy" Author  "$w": "$cy"MR.L4M3R"
sleep 1
echo $cy" Github  "$w": "$cy"https://github.com/MR-L4M3R"
sleep 1
echo $cy" YouTube "$w": "$cy"MR.L4M3RXploit"
sleep 1
echo $cy" Team    "$w": "$cy"Sumber Cyber Team"
sleep 1
echo $w"==============================================="
echo
sleep 1
...
sleep 1
echo
echo $w"["$r"1"$w"] "$p"Install Bahan Dulu Coeg"
sleep 1
