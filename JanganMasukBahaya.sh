...
echo $r"SABAR "$b"BRO "$cy"INSTALL "$p"BAHANNYA "$g"DULU COEG...."
sleep 3
...
figlet "Tools"
echo $w"———————————————————————————————————————————"
echo $cy" Author"$r"  : "$cy"MR.L4M3R "
echo $cy" YouTube"$r" : "$cy"MR.L4M3RXploit "
echo $cy" Team"$r"    : "$cy"Sumber Cyber Team"
echo $w"———————————————————————————————————————————"
	sleep 3
echo
echo
